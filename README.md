...
Additionally, the values of `k, n = |S|, m' = length of substring passed through mutation channel, average recoverability, and average empirical runtime of chaining + extension` are printed in the following way:
